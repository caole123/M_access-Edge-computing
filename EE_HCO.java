...
public class EE_HCO {
	...
	public static double exe(List<Processor> givenProcessorList, Integer[][] compMartrix, Integer[][] commMartrix, Double rgoal, Double deadline, boolean print ) throws IOException, ClassNotFoundException {
		...
		while (true) {
			...
			for (int j = 1; j < givenProcessorList0.size(); j++) {
				Processor verP = givenProcessorList0.get(j);
				...
				if (heftXMakespan <= deadline) {
					heftXReliability = ReEnhance.exe(givenProcessorListx, deadline, gx,print);
		...
		System.out.println("EE_HCO-generated total COST is " + DoubleUtil.format(totalCost));
		System.out.println("EE_HCO-generated computation value is " + (ft - st) / 1000 + " s");
		System.out.println("EE_HCO-generated turned-on processor number is " + processorNumber);
		System.out.println("EE_HCO-generated reliability is " + finalG.getReliability());
		System.out.println("EE_HCO-generated response time is " + finalG.getLower_bound());
		System.out.println("EE_HCO-generated turned off is " + minProcessors);
